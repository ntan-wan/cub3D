...
/*   Updated: 2023/04/16 14:35:44 by ntan-wan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	handle_keypress(int keycode, t_game *game)
{
	...
	if (keycode == ESC)
		...
		player_rotate_right(game->map->player);
	else if (keycode == KEY_A)
		player_rotate_left(game->map->player);
	else if (keycode == KEY_W)
		player_move_forward(game->map->player);
	else if (keycode == KEY_S)
		player_move_backward(game->map->player);
	return (SUCCESS);
}
